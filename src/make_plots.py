...
prec_rec_cnn_dic = {
    ...
    'SN2':[
        #Precision
        [
            [0.95,	0.77, 0.00, 0.00, 0.71],
            [0.89,	0.74, 0.04, 0.01, 0.84],
            [0.85,	0.72, 0.01, 0.03, 0.59],
            [0.89,	0.78, 0.00, 0.00, 0.65],
            [0.80,	0.78, 0.00, 0.00, 0.59],
            [0.88,	0.78, 0.00, 0.00, 0.62],
            [0.79,	0.79, 0.00, 0.00, 0.55],
        ],
        #Recall
        [
            [1.00,	0.91, 0.00, 0.00, 0.10],
            [0.99,	0.85, 0.10, 0.03, 0.09],
            [0.98,	0.82, 0.02, 0.03, 0.09],
            [1.00,	0.88, 0.00, 0.00, 0.15],
            [1.00,	0.87, 0.00, 0.00, 0.12],
            [1.00,	0.87, 0.00, 0.00, 0.17],
            [1.00,	0.85, 0.00, 0.00, 0.13],
        ]
    ],
    'HAR1':[
        #Precision
...
prec_rec_lstm_dic = {
    ...
    'SN2':[
        #Precision
        [
            [0.97,	0.76, 0.00, 0.00, 0.96],
            [0.93,	0.71, 0.06, 0.02, 0.95],
            [0.86,	0.70, 0.02, 0.03, 0.94],
            [0.87,	0.76, 0.00, 0.00, 1.00],
            [0.81,	0.75, 0.00, 0.00, 1.00],
            [0.86,	0.76, 0.00, 0.00, 0.97],
            [0.79,	0.76, 0.00, 0.00, 1.00],
        ],
        #Recall
        [
            [1.00,	0.97, 0.00, 0.00, 0.06],
            [0.99,	0.95, 0.10, 0.03, 0.08],
            [0.98,	0.92, 0.02, 0.03, 0.04],
            [1.00,	0.95, 0.00, 0.00, 0.07],
            [1.00,	0.98, 0.00, 0.00, 0.07],
            [1.00 ,	0.95, 0.00, 0.00, 0.08],
            [1.00,	0.97, 0.00, 0.00, 0.10],
        ]
    ],
    'HAR1':[
        #Precision
...
prec_rec_trans_dic = {
    ...
    'SN2':[
        #Precision
        [
            [0.98,	0.78, 0.00, 0.00, 0.59],
            [0.93,	0.74, 0.05, 0.01, 0.63],
            [0.86,	0.75, 0.03, 0.03, 0.72],
            [0.90,	0.78, 0.00, 0.00, 0.66],
            [0.81,	0.76, 0.02, 0.00, 0.69],
            [0.88,	0.76, 0.01, 0.00, 0.74],
            [0.82,	0.77, 0.00, 0.00, 0.57]
        ],
        #Recall
        [
            [1.00,	0.92, 0.00, 0.00, 0.12],
            [0.99,	0.89, 0.10, 0.03, 0.16],
            [0.98,	0.85, 0.03, 0.03, 0.18],
            [1.00,	0.89, 0.00, 0.00, 0.18],
            [1.00,	0.93, 0.25, 0.00, 0.15],
            [1.00,	0.90, 0.25, 0.00, 0.13],
            [1.00,	0.92, 0.00, 0.00, 0.13]
        ]
    ],
    'HAR1':[
        #Precision
...
prec_rec_svm_dic = {
    ...
    'SN2':[
        #Precision
        [
            [0.91,	0.68, 0.00, 0.00, 0.00],
            [0.88,	0.65, 0.00, 0.00, 0.00],
            [0.83,	0.64, 0.00, 0.00, 0.00],
            [0.84,	0.68, 0.00, 0.00, 0.00],
            [0.77,	0.68, 0.00, 0.00, 0.00],
            [0.84,	0.68, 0.00, 0.00, 0.00],
            [0.77,	0.68, 0.00, 0.00, 0.00]
        ],
        #Recall
...
prec_rec_nb_dic = {
    ...
    'SN2':[
        #Precision
        [
            [1.00,	0.73, 0.05, 0.00, 0.93],
            [0.96,	0.67, 0.10, 0.01, 0.60],
            [0.93,	0.27, 0.00, 0.00, 0.88],
            [0.93,	0.73, 0.02, 0.11, 0.95],
            [0.83,	0.73, 0.02, 0.00, 0.95],
            [0.91,	0.73, 0.01, 0.00, 0.95],
            [0.83,	0.73, 0.01, 0.00, 0.95],
        ],
        #Recall
        [
            [1.00,	0.99, 0.50, 0.00, 0.14],
            [0.93,	0.96, 0.10, 0.03, 0.02],
            [0.01,	0.98, 0.00, 0.00, 0.07],
            [0.85,	0.99, 0.50, 0.21, 0.17],
            [1.00,	0.99, 0.50, 0.00, 0.17],
            [1.00,	0.99, 0.25, 0.00, 0.17],
            [1.00,	0.99, 0.25, 0.00, 0.17],
        ]
    ],
    'HAR1':[
...
prec_rec_rf_dic = {
    ...
    'SN2':[
        #Precision
        [
            [0.99,	0.74, 0.04, 0.00, 0.90],
            [0.95,	0.70, 0.05, 0.00, 0.67],
            [0.89,	0.69, 0.02, 0.01, 0.67],
            [0.92,	0.73, 0.03, 0.00, 0.96],
            [0.83,	0.74, 0.04, 0.05, 0.79],
            [0.91,	0.74, 0.00, 0.00, 0.76],
            [0.83,	0.74, 0.02, 0.02, 0.89],
        ],
        #Recall
        [
            [1.00,	0.98, 0.50, 0.00, 0.09],
            [0.99,	0.93, 0.07, 0.00, 0.08],
            [0.98,	0.90, 0.02, 0.02, 0.06],
            [1.00,	0.98, 0.25, 0.00, 0.06],
            [0.99,	0.98, 0.50, 0.02, 0.06],
            [1.00,	0.97, 0.00, 0.00, 0.09],
            [0.99,	0.98, 0.25, 0.01, 0.08],
        ]
    ],
    'HAR1':[
        #Precision
