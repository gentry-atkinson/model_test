...
Important note:  The current data set is two subject, so a validation set is not going to be subject independent.
...
full_filename = my_path+os.path.join('/e4_wristband_Nov2019/'+'e4_get_x_y_sub.py')
...
def e4_load_dataset(
    ...
    X, y, sub, xys_info = get_X_y_sub(working_dir='src/temp', zip_flist = e4_flist)
